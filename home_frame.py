...
def take_alive_files():
    ...
    for filename in os.listdir('/Users/matous/PycharmProjects/Cash_Managment_App/files'):
        if os.path.isfile(os.path.join('/Users/matous/PycharmProjects/Cash_Managment_App/files', filename)):
...
class HomeFrame(customtkinter.CTkFrame):
    ...
    def select_file(self, name=None):
        ...
        with open('/Users/matous/PycharmProjects/Cash_Managment_App/files/' + name + ".json", 'r') as f:
            data = json.load(f)
